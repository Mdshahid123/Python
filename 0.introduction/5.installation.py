 #we need two main things to start working with Python:

#1)-IDE / Code Editor – where you write your  Python code.
...
# 2)selction of IDE:most popular ide for python is vs code 